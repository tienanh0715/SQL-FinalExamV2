...
public class ScannerUtils {
    ...
    public static String StringContainsSpecialCharacter(String errorMessage){
        String name;
        while (true){
            name = scanner.nextLine();
            Pattern pattern = Pattern.compile("[^a-zA-ZÁẢÀÃẠẮẲẰẴẶẤẨẦẪẬÉẺÈẼẸẾỂỀỄỆĐÍỈÌĨỊÓỎÒÕỌỐỔỒỖỘỚỞỜỠỢÚỦÙŨỤỨỬỪỮỰáảàãạắẳằẵặấẩầẫậéẻèẽẹếểềễệđíỉìĩịóỏòõọốổồỗộớởờỡợúủùũụứửừữự ]");
